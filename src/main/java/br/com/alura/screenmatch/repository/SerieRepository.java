...
public interface SerieRepository extends JpaRepository<Serie, Long> {
    ...
    @Query("""
            ...
            """)
    List<Episodio> ListarTopEpisodios(Serie serie);
    ...
    @Query("""
            ...
            FROM Serie s
            JOIN s.episodios e
            WHERE s = :serie AND YEAR(e.dataLancamento) >= :ano
            """)
    List<Episodio> ListarEpisodioApartirDeUmaData(Serie serie, int ano);
}
